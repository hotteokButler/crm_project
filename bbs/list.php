...
if ($sca || $stx || $stx === '0') {     //검색이면
    ...
    // 라엘님제안 코드로 대체 http://sir.kr/g5_bug/2922
...
$crm_write_pages = $bo_table && $stx ? '&wr_5='.$wr_5 :'' ;

$write_pages = get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, get_pretty_url($bo_table, '', $qstr.'&amp;page='),$crm_write_pages);
