	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cm_wrap">
            ...
            <header style="z-index:<?php echo $cmt_sv; ?>">
	            <span style="margin-right:5px; color:#6EB677;"><?php echo $list[$i]['name'] ?></span>
	            <?php if ($is_ip_view) { ?>	            
	            <?php } ?>
	            <span class="sound_only">작성일</span>
                <? $today2 = date("Ymd");?>
	            <span class="bo_vc_hdinfo dm">  <time datetime="<?php echo date('Y-m-d\TH:i:s+09:00', strtotime($list[$i]['datetime'])) ?>"><?php echo $list[$i]['datetime'] ?></time></span>
	            <?php
	        ...
	        <!-- 댓글 출력 -->
	        <div class="cmt_contents color_sub">
	            <p>
